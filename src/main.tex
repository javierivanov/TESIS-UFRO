...
%%%%%%%%% Vars %%%%%%%%%
\newcommand{\titulotesis}{ETAPA DE PRE-PROCESAMIENTO DE MINERÍA DE DATOS\\ PARA REGISTROS DE ALMA COMMON SOFTWARE}
\newcommand{\nombre}{JAVIER IGNACIO FUENTES MUÑOZ}
\newcommand{\anyo}{2016}
\newcommand{\profesorguia}{PATRICIO ABEL GALEAS ECHEVERRÍA}
\newcommand{\profesorcoguia}{GLORIA MILLARAY JULIA CURILEM SALDIAS}
...
\lfoot{\fontsize{10pt}{12pt}\selectfont \textbf{\titulotesis}}
...
\fancypagestyle{plain}{\fancyhf{}
	\fancyfoot[LE,LO]{\fontsize{10pt}{12pt}\selectfont \textbf{\titulotesis}}
